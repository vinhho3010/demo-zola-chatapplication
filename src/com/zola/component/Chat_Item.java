...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/zola/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/zola/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.zola.swing.JIMSendTextPane();
    ...
    private com.zola.swing.JIMSendTextPane txt;
