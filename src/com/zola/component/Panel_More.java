...
import com.zola.emoji.Emogi;
import com.zola.emoji.Model_Emoji;
import com.zola.event.PublicEvent;
import com.zola.main.Main;
...
import com.zola.swing.WrapLayout;
...
public class Panel_More extends javax.swing.JPanel {
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/zola/icon/image.png")));
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/zola/icon/link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();
