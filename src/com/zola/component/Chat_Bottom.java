...
import com.zola.app.MessageType;
...
import com.zola.swing.JIMSendTextPane;
...
public class Chat_Bottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/zola/icon/send.png")));
        ...
        cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/zola/icon/more_disable.png")));
        cmdMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (panelMore.isVisible()) {
                    ...
                    cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/zola/icon/more.png")));
